...
function Login() {
    ...
    const user = useUser();
    const [ buttonTittle, setButtonTittle ] = useState('Buy 1 NFT to gain access');


    useEffect(() => {
      // Connect to the BSC network (use a reliable BSC provider)
      const web3 = new Web3('https://bsc-dataseed.binance.org/');

      // Define the contract and the wallet address
